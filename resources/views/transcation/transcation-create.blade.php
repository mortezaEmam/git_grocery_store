        ...
        <div class="col-md-12">
            ...
            <form action="{{route('transcation.store')}}" method="post">
                ...
                <tr >
                    ...
                    <td><input  type="hidden" name="user_id" value="{{auth()->id()}}"/>{{auth()->user()->name}}</td>
                    ...
                    <td><input type="tel" name="phone" value="{{old('phone')}}" placeholder="شماره همراه خود را وارد کنید"></td>
