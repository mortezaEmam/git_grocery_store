...
جستجو محصول ..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search a product...';}" required="">
    ...
    <div class="banner">
        ...
        <div class="w3l_banner_nav_left">
            <div class="w3l_banner_nav_left_banner5">
            ...
            <div class="w3ls_w3l_banner_nav_left_grid w3ls_w3l_banner_nav_left_grid_veg">
                <h3 class="w3l_fruit">لیست کالا</h3>
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="29" data-name="Fresh bananas" data-summary="summary 29" data-price="10.00" data-quantity="1" data-image="images/29.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="30" data-name="Fresh cauliflower" data-summary="summary 30" data-price="5.00" data-quantity="1" data-image="images/30.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="31" data-name="Fresh brinjal bharta" data-summary="summary 31" data-price="2.00" data-quantity="1" data-image="images/31.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="32" data-name="Fresh sweet lime loose" data-summary="summary 32" data-price="6.00" data-quantity="1" data-image="images/32.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="33" data-name="Fresh basket onion" data-summary="summary 33" data-price="5.00" data-quantity="1" data-image="images/33.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="34" data-name="Fresh muskmelon stripped" data-summary="summary 34" data-price="4.00" data-quantity="1" data-image="images/34.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="35" data-name="Fresh basket mushroom" data-summary="summary 35" data-price="11.00" data-quantity="1" data-image="images/35.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
                                ...
                                <div class="agile_top_brand_right_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            ...
                                            <div class="snipcart-details">
                                                <button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="36" data-name="Fresh basket strawberry" data-summary="summary 36" data-price="7.00" data-quantity="1" data-image="images/36.png">افزودن به سبد کالا</button>
                                            </div>
                                        </div>
                                    </figure>
                                </div>
