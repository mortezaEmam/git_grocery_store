...
نان و نانوایی</a></li>
		...
		<div class="w3l_banner_nav_left">
			<div class="w3l_banner_nav_left_banner9 w3l_banner_nav_left_banner_pet">
				<h4>غذاهای مورد علاقه</h4>
				<p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم</p>
				<a href="single.html">فروشگاه در حال حاضر</a>
			</div>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="57" data-name="Can - tuna for cats" data-summary="summary 57" data-price="8.00" data-quantity="1" data-image="images/57.png">
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="58" data-name="Junior pet food" data-summary="summary 58" data-price="5.00" data-quantity="1" data-image="images/58.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="4" data-name="Dogs food" data-summary="summary 4" data-price="9.00" data-quantity="1" data-image="images/4.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="59" data-name="Gravy food for dogs" data-summary="summary 59" data-price="15.00" data-quantity="1" data-image="images/59.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="60" data-name="Meat for dogs" data-summary="summary 60" data-price="8.00" data-quantity="1" data-image="images/60.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="61" data-name="Oral care weekly pack" data-summary="summary 61" data-price="5.00" data-quantity="1" data-image="images/61.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="62" data-name="Dog munchies" data-summary="summary 62" data-price="6.00" data-quantity="1" data-image="images/62.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="63" data-name="Nutrition for cats" data-summary="summary 63" data-price="6.00" data-quantity="1" data-image="images/63.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
...
لورم ایپسوم یا طرح‌نما </p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="25" data-name="Food for adult dogs" data-summary="summary 25" data-price="3.00" data-quantity="1" data-image="images/25.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
...
لورم ایپسوم یا طرح‌نما </p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="26" data-name="Young adult dogs" data-summary="summary 26" data-price="6.00" data-quantity="1" data-image="images/26.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
...
لورم ایپسوم یا طرح‌نما </p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="27" data-name="Cat food ocean fish" data-summary="summary 27" data-price="6.00" data-quantity="1" data-image="images/27.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
...
لورم ایپسوم یا طرح‌نما </p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="28" data-name="Chicken in jelly can" data-summary="summary 28" data-price="7.00" data-quantity="1" data-image="images/28.png">
اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
