        ...
        <div class="col-lg-12">
            <section class="panel mb-4">
                <header class="panel-heading">
                    <a class="btn btn-outline-dark" href="{{route('category.create')}}">افزودن دسته جدید</a>
                    <span>  تعداد کل :{{count($categories)}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-control custom-switch">
                                    <input name="info[status]" type="checkbox" class="custom-control-input" id="{{$category->id}}" disabled
                                    @if ($category->status=='on') checked @endif
                                    >
                                    <label class="custom-control-label" for="{{$category->id}}"></label>
                                </div>
                            </td>
                            <td><a href="{{route('category.edit',['category'=>$category->id])}}" class="btn btn-primary btn-xs">
                            ...
                            <td><a href="{{route('category.destroy',['category'=>$category->id])}}" class="btn btn-danger btn-xs">
                        ...
                        <tr>
                            <td>
                                ...
                                <a class="title" href="#"> {{$subcat->title}}</a></td>
                            <td>{{$subcat->sort}}</td>
                            <td>
                                <div class="custom-control custom-switch">
                                    <input name="info[status]" type="checkbox" class="custom-control-input" id="{{$subcat->id}}" disabled
                                   @if ($subcat->status=='on') checked @endif >
                                    <label class="custom-control-label" for="{{$subcat->id}}"></label>
                                </div>
                            </td>
                            <td><a href="{{route('category.edit',['category'=>$subcat->id])}}" class="btn btn-primary btn-xs">
                                    <svg class="bi bi-pencil" width="1.2em" height="1.2em"
                                         viewBox="0 0 16 16" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                            ...
                            <td><a href="{{route('category.destroy',['category'=>$subcat->id])}}" class="btn btn-danger btn-xs">
                                    <svg class="bi bi-trash" width="1.2em" height="1.2em"
                                         viewBox="0 0 16 16" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5.5 5.5A.5.5 0 016 6v6a.5.5 0 01-1 0V6a.5.5 0 01.5-.5zm2.5 0a.5.5 0 01.5.5v6a.5.5 0 01-1 0V6a.5.5 0 01.5-.5zm3 .5a.5.5 0 00-1 0v6a.5.5 0 001 0V6z"></path>
