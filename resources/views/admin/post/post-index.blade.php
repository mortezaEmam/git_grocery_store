                        ...
                        <tr>
                            ...
                            <td>
                                <div class="custom-control custom-switch">
                                    <input name="status" type="checkbox" class="custom-control-input" id="{{$post->id}}" disabled
                                    @if ($post->status=='on') checked @endif
                                    >
                                    <label class="custom-control-label" for="{{$post->id}}"></label>
                                </div>
                            </td>
                            <td><a href="{{route('post.edit',['post'=>$post->id])}}" class="btn btn-primary btn-xs">
                            ...
                            <td><a href="{{route('post.destroy',['post'=>$post->id])}}" class="btn btn-danger btn-xs">
