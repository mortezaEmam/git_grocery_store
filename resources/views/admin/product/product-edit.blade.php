                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('product.update',['product'=>$product->id]) }}" method="post"
                        ...
                        @if(!filled($warehousedetaile))
                            ...
                            <input type="checkbox" name="warhouse_panel" id="warehouse-panel"
                                   onclick="AddProductWarehous()">
                        @else
                            <input type="hidden" name="warhouse_panel" value="on">
                        @endif
                        <div class="row">
                            <div class="col-md-9">
                                        ...
                                        @foreach($descriptions as $item)
                                            ...
                                            <tr id="description_id-{{$item->id}}" style="padding-bottom: 5px;">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" onclick="delete_quantiy('{{$item->id}}')"
                                    ...
                                    <div class="container"
                                        ...
                                        <select class="form-control col-md-8" name="warehouse_id" required>
                                            ...
                                            @foreach($warehouses as $warehouse)
                                                <option @if($warehouse->id==$warehousedetaile->warehouse_id) selected @endif value="{{$warehouse->id}}">{{$warehouse->address}}</option>
                                            @endforeach
                                        </select>
                                        <hr>
                                ...
                                <div class="box-widget">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input name="status" type="checkbox" class="custom-control-input"
                                               id="customSwitch1" @if($product->status=='on') checked @endif>
