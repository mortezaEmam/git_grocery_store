        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <a class="btn btn-outline-dark" href="{{route('warehouse.create')}}">افزودن انبار جدید</a>
                    <span>  تعداد کل :{{count($warehouses)}}
                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('warehouse.edit',['warehouse'=>$warehouse->id])}}" class="btn btn-primary btn-xs">
                            ...
                            <td><a href="{{route('warehouse.destroy',['warehouse'=>$warehouse->id])}}" class="btn btn-danger btn-xs">
