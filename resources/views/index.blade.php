...
@section('content')
    <div class="banner">
                            ...
                            @if($category->parent_id==0)
                                <li class="dropdown mega-dropdown active">
                                    <a href="{{route('category.show',['category'=>$category->id])}}"
                                       class="dropdown-toggle">{{$category->title}}<span class="caret"></span></a>
                                    @endif
                                        ...
                                        @if($sub->parent_id==$category->id)
                                            <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                                                <div class="w3ls_vegetables">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="{{route('category.show',['category'=>$sub->id])}}">{{$sub->title}}</a>
                                                        </li>
                                                    </ul>
        ...
        <div class="w3l_banner_nav_left">
            ...
            <!-- flexSlider -->
            <link rel="stylesheet" href="{{asset('master/css/flexslider.css')}}" type="text/css" media="screen"
                  property=""/>
            ...
            <div class="w3l_fresh_vegetables_grids">
                <div class="col-md-3 w3l_fresh_vegetables_grid w3l_fresh_vegetables_grid_right">
                    <div class="w3l_fresh_vegetables_grid2">
                        <ul>
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.html">همه برندها</a>
                            </li>
                            ...
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="bread.html">نان و نانوایی</a>
                            </li>
                            ...
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.html">
                                    ادویه ها</a></li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.html">میوه های خشک</a>
                            </li>
                            <li><i class="fa fa-check" aria-hidden="true"></i><a href="products.html">محصولات لبنی</a>
                            </li>
                        </ul>
                    </div>
                </div>
