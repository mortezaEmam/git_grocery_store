...
ثبت نام</a></li>
		...
		<div class="w3l_header_left1">
			<h2><a href="mail.html">تماس با ما
			</a></h2>
		</div>
...
نان و نانوایی</a></li>
		...
		<div class="w3l_banner_nav_left">
			<div class="w3l_banner_nav_left_banner4">
				<h3>بهترین تخفیف برای محصولات جدید<span class="blink_me"></span></h3>
			</div>
								...
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="17" data-name="Dishwash gel, lemon" data-summary="summary 17" data-price="8.00" data-quantity="1" data-image="images/17.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="18" data-name="Dish wash bar" data-summary="summary 18" data-price="2.00" data-quantity="1" data-image="images/18.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>خوشبو کننده هوا (50gm)</p>
											<h4>$3.00 <span>$5.00</span></h4>
										</div>
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="19" data-name="Air freshener" data-summary="summary 19" data-price="3.00" data-quantity="1" data-image="images/19.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>
متخصص پاک کننده (1 RTL)</p>
											<h4>$6.00 <span>$7.00</span></h4>
										</div>
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="20" data-name="Toilet cleaner expert" data-summary="summary 20" data-price="6.00" data-quantity="1" data-image="images/20.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
...
لورم ایپسوم یا طرح‌نما</p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="21" data-name="Packaging container pack" data-summary="summary 21" data-price="8.00" data-quantity="1" data-image="images/21.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="22" data-name="Signoraware container" data-summary="summary 22" data-price="5.00" data-quantity="1" data-image="images/22.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="23" data-name="Stainless steel sauce pan" data-summary="summary 23" data-price="6.00" data-quantity="1" data-image="images/23.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="24" data-name="Stainless steel dabba" data-summary="summary 24" data-price="6.00" data-quantity="1" data-image="images/24.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>مواد غذایی (80 گرم)</p>
											<h4>$3.00 <span>$4.00</span></h4>
										</div>
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="25" data-name="Food for adult dogs" data-summary="summary 25" data-price="3.00" data-quantity="1" data-image="images/25.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
...
لورم ایپسوم یا طرح‌نما</p>
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="26" data-name="Young adult dogs" data-summary="summary 26" data-price="6.00" data-quantity="1" data-image="images/26.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="27" data-name="Cat food ocean fish" data-summary="summary 27" data-price="6.00" data-quantity="1" data-image="images/27.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
							...
							<div class="agile_top_brand_right_grid1">
								<figure>
									<div class="snipcart-item block">
										...
										<div class="snipcart-details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="28" data-name="Chicken in jelly can" data-summary="summary 28" data-price="7.00" data-quantity="1" data-image="images/28.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
