...
نان و نانوایی</a></li>
		...
		<div class="w3l_banner_nav_left">
			<div class="w3l_banner_nav_left_banner6">
...
سبزیجات</h4>
			...
			<div class="w3ls_w3l_banner_nav_left_grid">
				<div class="w3ls_w3l_banner_nav_left_grid_head">
					<h6>
دسته بندی ها محبوب</h6>
				</div>
				<div class="w3ls_w3l_banner_nav_left_grid_head_grids">
					<div class="col-md-4 w3ls_w3l_banner_nav_left_grid_head_grid">
...
نوشیدنی های انرژی زا</a></li>
					...
					<div class="col-md-4 w3ls_w3l_banner_nav_left_grid_head_grid">
						...
						<ul>
							...
							<li><a href="frozen.html">اسنک منجمد</a></li>
							<li><a href="frozen.html">
منجمد ذرت شیرین</a></li>
							<li><a href="frozen.html">سبزیجات منجمد</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
				</div>
								...
								<figure>
									<div class="snipcart-item block" >
										...
										<div class="snipcart-details top_brand_home_details">
											<button class="btn btn-danger my-cart-btn hvr-sweep-to-left" data-id="1" data-name="Fortune sunflower oil" data-summary="summary 1" data-price="7.99" data-quantity="1" data-image="images/1.png">اضافه کردن به سبد</button>
										</div>
									</div>
								</figure>
							</div>
