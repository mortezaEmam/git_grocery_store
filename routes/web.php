...
use \App\Http\Controllers\WareHouseDetaileController;
...
//    Route::get('{warehouse}/show',[WareHousController::class,'show'])->name('warehouse.show');
...
//});
//Route::prefix('warehouse-detailes')->middleware(['auth'])->group(function (){
//    Route::get('/',[WareHouseDetaileController::class,'index'])->name('warehouseDetaile.index');
//    Route::get('/create',[WareHouseDetaileController::class,'create'])->name('warehouseDetaile.create');
//    Route::post('/store',[WareHouseDetaileController::class,'store'])->name('warehouseDetaile.store');
//    Route::get('/edit/{warehouseDetaile}/{warehouse}/',[WareHouseDetaileController::class,'edit'])->name('warehouseDetaile.edit');
//    Route::get('{warehouse}/show',[WareHouseDetaileController::class,'show'])->name('warehouseDetaile.show');
//    Route::post('{warehouseDetaile}/update',[WareHouseDetaileController::class,'update'])->name('warehouseDetaile.update');
//    Route::get('{warehouseDetaile}/destroy',[WareHouseDetaileController::class,'destroy'])->name('warehouseDetaile.destroy');
//});
...
//    Route::get('/recive',[MessageController::class,'recive'])->name('message.recive');
//    Route::get('/create',[MessageController::class,'create'])->name('message.create');
//    Route::get('{message}/edit',[MessageController::class,'edit'])->name('message.edit');
